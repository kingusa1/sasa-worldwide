...
const socials = [
  ...
  {
    href: 'https://www.instagram.com/sasa__worldwide',
    label: 'Instagram',
  ...
  {
    href: 'https://www.facebook.com/profile.php?id=61586521990816',
    label: 'Facebook',
    icon: 'M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z',
  },
  {
    href: 'https://www.linkedin.com/company/sasa-worldwide',
    label: 'LinkedIn',
    ...
    <footer className="bg-navy text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <p className="text-white/70 text-sm leading-relaxed mb-6">
              UAE&apos;s leading sales operations company. We transform how businesses connect with their customers through elite field teams and cutting-edge technology.
            </p>
            {/* Social Links */}
          ...
          <div>
            ...
            <div className="space-y-4 text-sm text-white/70">
              ...
              >
                Prime Business Center - Tower A,<br />
                Office NO. A1201, Jumeirah Village Circle,<br />
                Dubai, UAE.
              </a>
              <p>
                <a href="mailto:info@sasa-worldwide.com" className="hover:text-white transition-colors">
                  info@sasa-worldwide.com
                </a>
              </p>
              <p>
                <a href="tel:+97145843777" className="hover:text-white transition-colors">
                  +971 458 437 77
                </a>
              </p>
            </div>
        ...
        <div className="py-6 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-white/50">
          <p>
            &copy; {new Date().getFullYear()} SASA WORLDWIDE MANAGEMENT CONSULTANCIES CO LLC
          </p>
