...
export default function FloatingActions() {
  ...
  return (
    <>
        ...
        <div className="bg-white rounded-2xl shadow-2xl border border-gray-100 overflow-hidden w-64">
          ...
          <div className="p-3 space-y-2">
            <button
              ...
              className="w-full flex items-center gap-3 p-3 rounded-xl bg-gray-50 hover:bg-navy/5 transition-colors group"
            >
            ...
            <a
              ...
              className="w-full flex items-center gap-3 p-3 rounded-xl bg-gray-50 hover:bg-[#25D366]/10 transition-colors group"
            >
      ...
      >
        <div className="h-full bg-white rounded-3xl shadow-2xl overflow-hidden border border-gray-100 flex flex-col">
          {/* Header */}
          <div className="bg-gradient-to-r from-navy to-navy/90 px-5 py-4">
            <div className="flex items-center justify-between">
              ...
              <button
                onClick={handleClose}
                className="w-8 h-8 flex items-center justify-center rounded-full hover:bg-white/10 transition-colors text-white/80 hover:text-white"
                aria-label="Close"
              >
      ...
      <div className="fixed bottom-6 right-6 z-50">
        ...
        >
          ...
          {/* Button container */}
          <div className={`relative w-16 h-16 rounded-full shadow-xl hover:shadow-2xl transition-all duration-300 flex items-center justify-center group-hover:scale-105 ${
            viewState === 'closed'
            ...
            {viewState === 'closed' ? (
              <>
                {/* Logo */}
                <div className="w-10 h-10 rounded-full bg-white p-1.5 shadow-inner">
                  <Image
                    src="/images/logo/sasa-logo-color.png"
                    alt="SASA"
                    width={32}
      ...
      {viewState !== 'closed' && (
        <div
          className="fixed inset-0 bg-black/30 z-40 backdrop-blur-sm md:bg-transparent md:backdrop-blur-none"
          onClick={handleClose}
        />
      )}
    </>
