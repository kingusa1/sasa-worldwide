...
export default function SalesError({
  ...
  useEffect(() => {
    console.error('[SASA HIGH] [sales]:', error.message);
  ...
  return (
    <div className="flex items-center justify-center min-h-[60vh] p-8">
      <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-8 max-w-md w-full text-center">
        ...
        <h2 className="text-lg font-bold text-gray-900 mb-1">Sales Portal Error</h2>
        <p className="text-sm text-gray-600 mb-4">Something went wrong loading this page.</p>

        <details className="mb-4 bg-gray-50 rounded-lg border border-gray-200 overflow-hidden text-left">
