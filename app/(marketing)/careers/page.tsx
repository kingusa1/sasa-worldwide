...
const careerPhases = [
  {
    ...
    readiness: 'Advance when consistently hitting 100%+ of targets for 3 consecutive months with zero compliance issues.',
  },
  {
    phase: 2,
    ...
    readiness: 'Advance when managing 3+ locations successfully with demonstrated client relationship skills and team mentoring capability.',
  },
  {
    phase: 3,
    title: 'Crew Manager',
    ...
    training: [
      'Leadership development program (8 weeks)',
      'Performance management certification',
      'Motivational techniques workshop',
      'HR fundamentals & compliance',
    ],
    readiness: 'Advance when team consistently ranks in top 20% and successfully developed 2+ agents to Account Manager level.',
  },
  {
    phase: 4,
    ...
    readiness: 'Advance when demonstrating P&L ownership capability, successful strategic initiatives, and readiness for full campaign accountability.',
  },
  {
    phase: 5,
    title: 'Director',
